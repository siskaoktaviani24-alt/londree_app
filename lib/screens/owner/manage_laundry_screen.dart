...
class _ManageLaundryScreenState extends State<ManageLaundryScreen> {
  ...
  Future<void> saveLaundry() async {
    if (nameC.text.trim().isEmpty ||
      ...
      showMsg("Nama laundry, alamat, latitude, dan longitude wajib diisi", false);
      return;
    }
                            ...
                            children: [
                              ...
                              Expanded(
                                child: TextField(
                                  controller: lngC,
                                  keyboardType: TextInputType.number,
                                  decoration: deco("Longitude", Icons.map_outlined),
                                ),
                              ),
                            ],
                          ),
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  const SizedBox(width: 12),
                                  Text(
                                    isEditService ? "Edit Layanan" : "Tambah Layanan",
                                    style: const TextStyle(
                                      fontSize: 20,
                                      fontWeight: FontWeight.bold,
                                    ),
